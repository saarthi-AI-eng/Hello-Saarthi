...
async def send_message(
    ...
    assistant_content = await run_chat(message, history, mind_mode=False)
...
async def stateless_message(message: str, conversation_history: list[dict], mind_mode: bool = False) -> str:
    ...
    history.append({"role": "user", "content": message})
    return await run_chat(message, history, mind_mode=mind_mode)
